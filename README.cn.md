...
[![x-cmd/install — beads Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/beads.svg?lang=zh)](https://x-cmd.com/install/beads)
...
合计: **706,334** 行代码（覆盖前 5 种语言、共 **3079** 个文件）。
...
- **最新版本**: `v1.3.1-rc.1` (2026-09-15)
- **最近提交**: 2026-09-24
- **Release 含资产**: 11 个

## 流行度

- **Star**: 27,409 · **Fork**: 1,857 · **开放 issue**: 2,524 · **贡献者**: 451

## 累计统计

- **发布数**: 101 · **已合并 PR**: 2578 · **开放 PR**: 426 · **已关闭 issue**: 1652 · **开放 issue**: 872 · **提交数**: 10834
...
_数据快照: `data/card/260925.yml` · 2026-09-25T05:07:21Z._
